...
export function ProviderAdmin({ className, onChanged }: ProviderAdminProps) {
  ...
  const discover = async () => {
    ...
    try {
      ...
      setDiscoveries(next); setSelectedDiscoveries(new Set()); setStatus("idle");
